...
default['aws']['s3']['access_key'] = 'AKIAJ6WH2ZKPR2UESB4A'
default['aws']['s3']['secret_access_key'] = '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'
default['aws']['s3']['bucket'] = 'jboss-eap-cluster-config'
